...
export default function AuthenticationLayout({ children }) {
  return (
    <div className="flex max-w-lg mx-auto my-16 overflow-hidden bg-light1 rounded-lg lg:space-x-8 dark:bg-dark2 lg:max-w-5xl shadow-2xl dark:shadow-lg dark:shadow-mid3">
