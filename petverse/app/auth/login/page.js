...
export default function Login() {
  ...
  return (
    <>
      ...
      <form
        method="POST"
        action="https://www.creative-tim.com/twcomponents/login"
      >
        <input
          type="hidden"
          name="_token"
        ...
        <div className="mt-8">
          <button
            type="submit"
            className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform rounded-md bg-primary hover:bg-primary/70 focus:outline-none focus:bg-primary/70"
          >
            Sign in
          </button>
        </div>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <a
          href="https://www.creative-tim.com/twcomponents/register"
